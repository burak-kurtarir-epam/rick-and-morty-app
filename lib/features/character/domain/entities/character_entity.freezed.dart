...
mixin _$CharacterEntity {
  ...
  CharacterLocationEntity get origin => throw _privateConstructorUsedError;
...
abstract class $CharacterEntityCopyWith<$Res> {
  ...
  $CharacterLocationEntityCopyWith<$Res> get origin;
...
class _$CharacterEntityCopyWithImpl<$Res, $Val extends CharacterEntity>
  ...
  @pragma('vm:prefer-inline')
  $CharacterLocationEntityCopyWith<$Res> get origin {
    return $CharacterLocationEntityCopyWith<$Res>(_value.origin, (value) {
...
class _$CharacterEntityImpl implements _CharacterEntity {
  const _$CharacterEntityImpl(
      ...
      this.type = '',
      this.gender = '',
      this.origin = const CharacterLocationEntity(),
...
abstract class _CharacterEntity implements CharacterEntity {
  ...
  String get gender;
  @override
  CharacterLocationEntity get origin;
  @override
